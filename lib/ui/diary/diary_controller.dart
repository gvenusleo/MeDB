...
class DiaryController extends GetxController {
  ...
  Future<void> fetchData() async {
    try {
      ...
      Log.e('[DiaryController] fetchData: $e');
    }
  }
  ...
  /// 上拉加载更多
  void loadMore() {
    Log.d('[DiaryController] loadMore: offset = $offset');
    if (isLastPage.value) {
  ...
  void toReadView(dynamic item) {
    Get.toNamed('/diary/read', arguments: item);
  }

  /// 跳转到编辑页面添加数据
  Future<void> toEditView() async {
    await Get.toNamed('/diary/edit', arguments: {});
